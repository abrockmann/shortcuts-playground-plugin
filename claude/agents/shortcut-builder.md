...
- Keep source drafts and archives as XML. Do not manually pre-convert XML before signing unless the bundled `sign-shortcut` wrapper is applying its validator-clean format-error fallback on the final `.shortcut` copy.
